...
def modify():
	...
	#二、2 获取UDPN&共享带宽监控值
	UDPN_Metric_A = get_metric(Region_A,"udpn",UDPN_ID,"BandOut","BandOutMax","BandOutUsage","BandOutMaxUsage").get("DataSets")
	UDPN_Metric_B = get_metric(Region_B,"udpn",UDPN_ID,"BandOut","BandOutMax","BandOutUsage","BandOutMaxUsage").get("DataSets")
	ShareBandwidth_Metric_A = get_metric(Region_A,"sharebandwidth",Region_A_ShareBandwidthId,"BandIn","BandOut","NetworkInUsage","NetworkOutUsage").get("DataSets")
	ShareBandwidth_Metric_B = get_metric(Region_B,"sharebandwidth",Region_B_ShareBandwidthId,"BandIn","BandOut","NetworkInUsage","NetworkOutUsage").get("DataSets")
	
	Metric_Data = {}
	for i in ["A","B"]:
		for a in ["BandOut","BandOutMax","BandOutUsage","BandOutMaxUsage"]:
		...
		for b in ["BandIn","BandOut","NetworkInUsage","NetworkOutUsage"]:
